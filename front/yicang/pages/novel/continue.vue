<template>
	<main>
		...
		<div class="article-editor" style="margin-bottom: 5vh;">
			<textarea class="article-textarea" placeholder="请在此续写"></textarea>
		</div>

		<button class="button-continue" @click="openDialogFn();">上传续写</button>
		<uni-popup ref="popup">
			<div class="dialog">
